...
VIETNAMESE_TRANSCRIPT = (
    "Chào mọi người, cảm ơn tất cả đã có mặt hôm nay. Mục tiêu chính của chúng ta là xem xét tiến độ dự án "
    "phát triển ứng dụng mới và phân công nhiệm vụ cho tuần tới. Anna, bạn có thể cập nhật tình hình phát triển "
    "giao diện người dùng không? Vâng, John. Hiện tại, giao diện người dùng đã hoàn thành khoảng 70%. Chúng tôi đã "
    "xong phần thiết kế chính và đang thử nghiệm tính năng đăng nhập. Tuy nhiên, có một vấn đề nhỏ với tốc độ tải "
    "trang trên thiết bị di động. Tôi đề xuất dành thêm thời gian để tối ưu hóa. Tôi có thể hỗ trợ kiểm tra hiệu suất "
    "từ phía backend nếu cần. Tuần này, nhóm backend đã hoàn thành API đăng nhập và bắt đầu làm API thanh toán. "
    "Chúng tôi cần nhóm giao diện cung cấp thêm thông tin về định dạng dữ liệu mong muốn. Tuyệt vời, cảm ơn cả hai. "
    "Vậy chúng ta thống nhất nhé: Anna sẽ dẫn đầu việc tối ưu hóa giao diện di động, và Mike sẽ phối hợp để đảm bảo "
    "API phù hợp. Có câu hỏi nào về nhiệm vụ này không? Tôi muốn hỏi, liệu chúng ta có nên ưu tiên tính năng thanh "
    "toán trước hay tiếp tục với giao diện chính? Tốt, câu hỏi hay. Tôi nghĩ chúng ta nên ưu tiên giao diện chính để "
    "đảm bảo trải nghiệm người dùng mượt mà, sau đó mới tập trung vào thanh toán. Mọi người thấy ổn không? Đồng ý. "
    "Tôi sẽ lên kế hoạch để hoàn thành API thanh toán trong tuần sau. OK, vậy tuần tới Anna tập trung tối ưu giao diện, "
    "Mike hoàn thiện API thanh toán. Tôi sẽ gửi email tóm tắt các nhiệm vụ này. Có ý kiến gì thêm không? (Im lặng) Tốt, "
    "cảm ơn mọi người, chúng ta kết thúc tại đây."
)
