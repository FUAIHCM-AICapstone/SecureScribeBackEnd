...
import type { TaskResponse, TaskStatus, TaskUpdate } from '../../types/task.type';
                ...
                {isLoading ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nhắc nhở lúc</label>
                                <input
                                    type="datetime-local"
                        ...
                        <div className="flex justify-end space-x-3 pt-4">
                            <button type="button" onClick={onClose} className="px-4 py-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" disabled={mutation.isPending}>Hủy</button>
