...
from app.crud.meeting import crud_soft_delete_meetings_by_creator
from app.crud.user import crud_check_email_exists, crud_create_user, crud_delete_user_with_cascade, crud_get_or_create_user_device, crud_get_user_by_id, crud_get_user_projects_stats, crud_get_users, crud_update_user
...
def delete_user(db: Session, user_id: uuid.UUID, actor_user_id: uuid.UUID | None = None) -> bool:
    ...
    try:
        crud_soft_delete_meetings_by_creator(db, user_id)
