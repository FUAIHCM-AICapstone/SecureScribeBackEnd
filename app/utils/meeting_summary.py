...
async def _generate_section_summaries(transcript_text: str, sections: List[str]) -> Dict[str, str]:
    ...
    user_prompt = f"Transcript:\n{transcript_text}\n\nSummarize the meeting for the following sections: {sections_list}. Return a JSON object with keys [{json_keys}] where each value is a concise summary for that section. Do not include any text outside the JSON object."
