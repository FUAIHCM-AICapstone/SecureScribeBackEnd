...
class ConformerEncoder(nn.Module):
    def __init__(self, params):
        ...
        self.padding_mask = StreamingMask(
            ...
            right_context=0 if params.get("causal", False) else params.get("right_context", params["max_pos_encoding"]),
        )

        # Linear Proj
        self.linear = nn.Linear(
            params["subsampling_filters"][-1] * params["n_mels"] // 2 ** params["subsampling_layers"],
