...
class MeetingProcessor:
    ...
    def _build_workflow(self):
        ...
        workflow.add_conditional_edges("check_informative", lambda state: "extract_tasks" if state["is_informative"] else "generate_output", {"extract_tasks": "extract_tasks", "generate_output": "generate_output"})
