...
class Meeting(BaseDatabaseModel, table=True):
    """Meeting model"""
...
class AudioFile(BaseDatabaseModel, table=True):
    """Audio file model"""
...
class Transcript(BaseDatabaseModel, table=True):
    ...
    audio_concat_file: Optional[AudioFile] = Relationship(back_populates="transcript")


class MeetingNote(BaseDatabaseModel, table=True):
    """Meeting notes model"""
...
class MeetingBotLog(BaseDatabaseModel, table=True):
